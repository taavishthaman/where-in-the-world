...
import { setLoading, setCountries, setError, setQuery, setRegion } from '../features/CountriesList/countriesSlice'
...
export default function SearchBar() {
    ...
    return <div className={styles.inputWrapper}>
        { isDark ? <svg className={styles.searchIcon} xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
            ...
            <svg className={styles.searchIcon} xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
        ...
        <input ref={inputRef} type='text' placeholder='Search for a country...' className={`${styles.searchBar} ${isDark ? styles.searchBarDark : ''}`} onChange={(e) => changeHandler(e)}/>
    </div>
}